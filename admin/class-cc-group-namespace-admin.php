 ...
 * functionality, then refer to `public/class-cc-group-namespace.php`
 *
 * @package   Community_Commons_GroupName_Admin
 * @author  AuthorName
 */
class CC_GroupName_Admin {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'cc-group-namespace';
	...
	private function __construct() {
		...
		$this->version = group_namespace_get_plugin_version();
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'GroupName', 'cc-group-namespace' ),
			__( 'GroupName', 'cc-group-namespace' ),
			'manage_options',
			$this->plugin_slug,
	...
	public function add_action_links( $links ) {
		...
		return array_merge(
			array(
				'settings' => '<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_slug ) . '">' . __( 'Settings', 'cc-group-namespace' ) . '</a>'
			),
			$links
		);
	...
	public function report_custom_plugin( $custom_plugins, $group_id ) {
		if ( $group_id == group_namespace_get_group_id() ) {
			$custom_plugins[] = "CC GroupName";
		}
